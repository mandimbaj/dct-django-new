...
urlpatterns += i18n_patterns(
    ...
    path('admin/data-integration/connections/create/', admin_views.data_integration_connection_create, name='aho_data_integration_connection_create'),
    path('admin/data-integration/connections/<int:pk>/edit/', admin_views.data_integration_connection_edit, name='aho_data_integration_connection_edit'),
    path('admin/data-integration/connections/<int:pk>/delete/', admin_views.data_integration_connection_delete, name='aho_data_integration_connection_delete'),
    path('admin/data-integration/connections/<int:pk>/validate/', admin_views.data_integration_connection_validate, name='aho_data_integration_connection_validate'),
    path('admin/data-integration/connections/<int:pk>/field-mapping/', admin_views.data_integration_field_mapping, name='aho_data_integration_field_mapping'),
    path('admin/data-integration/failed-rows/', admin_views.data_integration_failed_rows, name='aho_data_integration_failed_rows'),
    path('admin/data-quality/failed-import-rows/', admin_views.data_integration_failed_rows, name='aho_data_quality_failed_import_rows'),
